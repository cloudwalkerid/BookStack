...
return [
    ...
    'role_asset_image_view_note' => 'Ini berkaitan dengan visibilitas di dalam pengelola gambar. Akses sebenarnya terhadap file gambar yang diunggah akan bergantung pada opsi penyimpanan gambar sistem.',
    'role_all' => 'Semua',
    'role_own' => 'Sendiri',
    ...
    // Users
    'users' => 'Pengguna',
    'users_index_desc' => 'Buat dan kelola akun pengguna individual dalam sistem. Akun pengguna digunakan untuk login serta atribusi konten dan aktivitas. Izin akses terutama berbasis peran, namun kepemilikan konten pengguna, dan faktor lainnya, juga dapat memengaruhi izin dan akses.',
    ...
    'users_password_desc' => 'Atur kata sandi yang digunakan untuk masuk ke aplikasi. Kata sandi ini harus terdiri dari setidaknya 8 karakter.',
    ...
    'users_external_auth_id_desc' => 'Ketika sistem autentikasi eksternal digunakan (seperti SAML2, OIDC, atau LDAP), ini adalah ID yang menghubungkan pengguna BookStack ini dengan akun pada sistem autentikasi tersebut. Anda dapat mengabaikan kolom ini jika menggunakan autentikasi bawaan berbasis email.',
    'users_password_warning' => 'Isi bagian di bawah ini hanya jika Anda ingin mengganti kata sandi untuk pengguna ini.',
    ...
    'users_social_accounts_desc' => 'Lihat status akun sosial yang terhubung untuk pengguna ini. Akun sosial dapat digunakan sebagai tambahan dari sistem autentikasi utama untuk mengakses sistem.',
    ...
    'users_api_tokens_desc' => 'Membuat dan mengelola token akses yang digunakan untuk melakukan autentikasi dengan BookStack REST API. Izin untuk API diatur melalui pengguna yang memiliki token tersebut.',
    ...
    'users_mfa_desc' => 'Atur otentikasi multi-faktor sebagai lapisan keamanan tambahan untuk akun pengguna Anda.',
    ...
    // Webhooks
    'webhooks' => 'Webhooks',
    'webhooks_index_desc' => 'Webhook adalah cara untuk mengirim data ke URL eksternal ketika tindakan dan peristiwa tertentu terjadi di dalam sistem, yang memungkinkan integrasi berbasis peristiwa dengan platform eksternal seperti sistem pesan atau notifikasi.',
    ...
    'webhooks_details_desc' => 'Berikan nama yang mudah dipahami dan endpoint POST sebagai lokasi untuk mengirimkan data webhook.',
    'webhooks_events' => 'Peristiwa Webhook',
    'webhooks_events_desc' => 'Pilih semua peristiwa yang harus memicu pemanggilan webhook ini.',
    'webhooks_events_warning' => 'Perlu diingat bahwa peristiwa ini akan dipicu untuk semua peristiwa yang dipilih, meskipun izin khusus diterapkan. Pastikan penggunaan webhook ini tidak mengekspos konten rahasia.',
    ...
    'webhooks_delete_warning' => 'Ini akan sepenuhnya menghapus webhook dengan nama \':webhookName\' dari sistem.',
    'webhooks_delete_confirm' => 'Apakah Anda yakin ingin menghapus webhook ini?',
    'webhooks_format_example' => 'Contoh Format Webhook',
    'webhooks_format_example_desc' => 'Data webhook dikirim sebagai permintaan POST ke endpoint yang dikonfigurasi dalam bentuk JSON dengan format berikut. Properti "related_item" dan "url" bersifat opsional dan bergantung pada jenis peristiwa yang dipicu.',
    ...
    // Licensing
    'licenses' => 'Lisensi',
    'licenses_desc' => 'Halaman ini menampilkan informasi lisensi untuk BookStack beserta proyek dan pustaka yang digunakan di dalam BookStack. Banyak proyek yang tercantum mungkin hanya digunakan dalam konteks pengembangan.',
